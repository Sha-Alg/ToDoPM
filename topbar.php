    ...
    <ul class="navbar-nav">
        ...
        <li>
            <a class="nav-link text-white" href="./" role="button">
                <large><b><?php echo $title ?></b></large>
            </a>
        </li>
    </ul>
              ...
              <span>
                <div class="d-felx badge-pill">
                  ...
                  <?php if (!empty($_SESSION['login_avatar'])): ?>
                      <img class="img-circle elevation-2 img-size-32"
                           src="https://todopmbucket.s3.eu-north-1.amazonaws.com/avatars/<?php echo $_SESSION['login_avatar'] ?>"
                           alt="User Avatar"
                           style="">
                  <?php else: ?>
