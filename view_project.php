            ...
            <div class="callout callout-danger">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-sm-6">
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">Project Name</b></dt>
                                <dd><?php echo ucwords($name) ?></dd>
                                <dt><b class="border-bottom border-fuchsia">Description</b></dt>
                                <dd><?php echo html_entity_decode($description) ?></dd>
                            </dl>
                        </div>
                        <div class="col-md-6">
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">Start Date</b></dt>
                                <dd><?php echo date("F d, Y", strtotime($start_date)) ?></dd>
                            </dl>
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">End Date</b></dt>
                                <dd><?php echo date("F d, Y", strtotime($end_date)) ?></dd>
                            </dl>
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">Status</b></dt>
                                <dd>
                                    <?php
                                    if ($stat[$status] == 'Pending') {
                                        echo "<span class='badge badge-secondary'>{$stat[$status]}</span>";
                                    } elseif ($stat[$status] == 'Started') {
                                        echo "<span class='badge badge-fuchsia'>{$stat[$status]}</span>";
                            ...
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">Progress</b></dt>
                                <dd>
                            ...
                            <dl>
                                <dt><b class="border-bottom border-fuchsia">Project Manager</b></dt>
                                <dd>
                                    <?php if (isset($manager['id'])) : ?>
                                        <div class="d-flex align-items-center mt-1">
                                            <img class="img-circle img-thumbnail p-0 shadow-sm border-info img-sm mr-3"
                                                 src="https://todopmbucket.s3.eu-north-1.amazonaws.com/avatars/<?php echo $manager['avatar'] ?>" alt="Avatar">
                    ...
                    <ul class="users-list clearfix">
                        ...
                        if (!empty($user_ids)):
                            ...
                            while ($row = $members->fetch_assoc()):
                                ?>
                                <li>
                                    <img src="https://todopmbucket.s3.eu-north-1.amazonaws.com/avatars/<?php echo !empty($row['avatar'])?$row['avatar']:'profile-avatar.png' ?>" alt="">
                ...
                <div class="card-header">
                    ...
                    <?php if ($_SESSION['login_type'] != 3): ?>
                        <div class="card-tools">
                            <button class="btn btn-primary  btn-sm" type="button" id="new_task"><i
                                        class="fa fa-plus"></i> New Task
                            </button>
                        </div>
                    <?php endif; ?>
                </div>
                            ...
                            while ($row = $tasks->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php else: ?>
                                            <a class="btn btn-primary view_task" href="javascript:void(0)"
                                               data-id="<?php echo $row['id'] ?>"
                                               data-task="<?php echo $row['task'] ?>">View</a>
                                        <?php endif; ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button class="btn btn-primary  btn-sm" type="button" id="new_productivity"><i
                                    class="fa fa-plus"></i> New Productivity
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    while ($row = $progress->fetch_assoc()):
                        ...
                        <div class="post">
                            ...
                            <div class="user-block">
                                ...
                                <?php endif; ?>
                                <img class="img-circle img-bordered-sm" src="https://todopmbucket.s3.eu-north-1.amazonaws.com/avatars/<?php echo !empty($row['avatar'])?$row['avatar']:'profile-avatar.png' ?>" alt="">
