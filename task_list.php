					...
					<tr>
						...
						<td class="text-center">
							<?php
							  if($stat[$row['pstatus']] =='Pending'){
							  	...
							  	echo "<span class='badge badge-fuchsia'>{$stat[$row['pstatus']]}</span>";
						...
						<td>
                        	...
                        	if($row['status'] == 1){
						  		...
						  		echo "<span class='badge badge-fuchsia'>On-Progress</span>";
                        	}elseif($row['status'] == 3){
                        ...
                        <td class="text-center text-nowrap">
                            <a class="btn btn-primary  new_productivity" data-pid = '<?php echo $row['pid'] ?>' data-tid = '<?php echo $row['id'] ?>'  data-task = '<?php echo ucwords($row['task']) ?>'  href="javascript:void(0)">Add Productivity</a>
                        </td>
					</tr>
				<?php endwhile; ?>
				</tbody>
